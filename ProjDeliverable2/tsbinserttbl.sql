...
-- -----------------------------------------------------
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(101,1001,'Rakshat','123 1st st. Jersey City, NJ, 07307');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(101,1002,'Ugandhara','221 South St. Jersey City, NJ, 07306');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(102,1003,'Kinjal','651A 3rd St. Hoboken, NJ, 07300');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(103,1004,'Divya','1123 Central Ave, Jersey City, NJ, 07307');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(104,1005,'Alex','382 3rd Ave, New York, NY, 12001');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(105,1006,'Bhuvan','112B 16th St. New York, NY, 12003');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(105,1007,'Jason','222 8st st. Jersey City, NJ, 07307');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(102,1005,'Alex','382 3rd Ave, New York, NY, 12001');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(103,1008,'Jeff','224 Cambridge Ave, Jersey city, NJ, 07307');
Insert into CUSTOMER(`businessID`,`custID`,`custName`,`custAddress`)
Values(107,1007,'JeffB','225 Cambridge Ave, Jersey city, NJ, 07307');
...
Insert into Review(`businessID`,`custID`,`review`,`status`,`review_date`)
